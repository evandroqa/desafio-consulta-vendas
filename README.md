# Desafio consulta vendas - Curso Dev Superior
> Formação Desenvolvedor Moderno<br>
Módulo: Back end<br>
Capítulo: JPA, consultas SQL e JPQL

Projeto de um sistema de vendas (Sale) e vendedores (Seller). Cada venda está para um vendedor, e um
vendedor pode ter várias vendas. Utilizado o Spring Boot com Java e banco de dados H2.
...
+ O Projeto foi implementado no modelo conceitual.<br>
![image](https://github.com/user-attachments/assets/796d5eab-dd43-4924-a72e-63d3fb92baed)


Após baixar o projeto deste repositório, start o aplicativo pela sua IDE favorita e depois faça as consultas no endereço: http://localhost:8080/h2-console <br><br>

Use a ferramenta de sua preferêencia para consultar as seguintes requisições:<br>

+ Sumário de vendas por vendedor (teste 1)<br>
GET /sales/summary?minDate=2022-01-01&maxDate=2022-06-30<br><br>
+ Sumário de vendas por vendedor (teste 2)<br>
GET /sales/summary<br>
Deverá retornar o sumário de vendas por vendedor dos últimos 12 meses.<br><br>
+ Relatório de vendas (teste 1)<br>
GET /sales/report<br>
Deverá retornar o relatório de vendas dos últimos 12 meses.<br><br>
+ Relatório de vendas (teste 2)<br>
GET /sales/report?minDate=2022-05-01&maxDate=2022-05-31&name=odinson<br><br>

O aquivo import.sql contém o seeding de povoamento inicial da tabela com os seguintes comandos:
~~~javascript
